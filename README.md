...
5. A co-pilot on a second controller can live-tune aim and power offsets during a match.
...
The co-pilot can live-tune turret aim and shooter power during a match. Offsets persist until reset.
...
Offsets accumulate — pressing D-pad Left 3 times shifts aim by 1.5 degrees. Current offsets are shown on the Calibration tab in Shuffleboard.
